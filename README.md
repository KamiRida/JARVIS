...
My responses (if deemed worthy enough by the Gemini 3.1 Flash reasoning model) are saved to a knowledge base that JARVIS has access to via RAG. In addition to this, it tracks my hand movements and lets me turn my lights on/off based on my hand movements.
